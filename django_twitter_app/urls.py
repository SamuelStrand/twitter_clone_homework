...
urlpatterns = [
    ...
    # path('post/<int:pk>/comment/detail/', views.post_delete, name='post_delete'),
    path('post/<int:pk>/comment/create/', views.post_comment_create, name='post_comment_create'),
    # path('post/<int:pk>/comment/update/', views.post_delete, name='post_delete'),
    path('post/<int:pk>/comment/delete/', views.post_comment_delete, name='post_comment_delete'),

    path('homework_task/', views.homework_task, name='homework_task'),
